...
<body>
    <header>
        <img src="<?php echo e(asset('logo.png')); ?>" alt="Together We Can">
        ...
        <a href="/download" class="btn">📱 Télécharger l'application</a>
    </header>
    ...
    <footer>
        ...
        <div style="margin-top: 12px;">© <?php echo e(date('Y')); ?> Together We Can. Tous droits réservés.</div>
    </footer>
</body>
</html>
